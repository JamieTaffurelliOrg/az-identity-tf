...
| <a name="input_role_assignments_groups"></a> [role\_assignments\_groups](#input\_role\_assignments\_groups) | The role assignments to give to groups | <pre>map(object(<br>    {<br>      group_reference = string<br>      role_reference  = string<br>    }<br>  ))</pre> | `{}` | no |
| <a name="input_role_assignments_service_principals"></a> [role\_assignments\_service\_principals](#input\_role\_assignments\_service\_principals) | The role assignments to give to service principals | <pre>map(object(<br>    {<br>      service_principal_reference = string<br>      role_reference              = string<br>    }<br>  ))</pre> | `{}` | no |
| <a name="input_role_assignments_users"></a> [role\_assignments\_users](#input\_role\_assignments\_users) | The role assignments to give to users | <pre>map(object(<br>    {<br>      user_reference = string<br>      role_reference = string<br>    }<br>  ))</pre> | `{}` | no |
